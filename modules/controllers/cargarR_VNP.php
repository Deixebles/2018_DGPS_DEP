...
if(isset($_POST['fecha']))
{
    ...
    $command = 'C:\Program Files\R\R-3.3.3\bin\Rscript.exe C:\xampp\htdocs\GestioDeute\scripts\predic\RpredVNP.R' . " $N";
...
<div>
    <div class="container">
        ...
        <div class="row">
            <h2 class="left" style="color: darkslateblue;margin-top: 3%">Veure les dades:     <a href="../../scripts/predic/Vetllador No Professional Ordinaria.html">click</a></h2>
