...
if(isset($_POST['fecha']))
{
    ...
    $command = 'C:\Program Files\R\R-3.3.3\bin\Rscript.exe C:\xampp\htdocs\GestioDeute\scripts\predic\RpredPVS.R' . " $N";
...
<div>
    <div class="container">
        ...
        <div class="row">
            <h5 class="left" style="color: darkslateblue;margin-top: 3%">Veure les dades:    <a href="../../scripts/predic/Prestacions Vinculades al Servei Ordinaria.html">click</a></h5>
        </div>
