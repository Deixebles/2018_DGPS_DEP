...
#install.packages("sqldfl")
#install.packages("zoo")
#install.packages("plyr")
#install.packages("ggplot2")
#install.packages("gridExtra")
#install.packages("rowr")
#install.packages("stringil")
...
Baixes_info<-Baixes_info[is.na(Baixes_info$IMPORD.y)==FALSE,] # traiem de baixes info els que estan en situació RETINGUDA (els que no surten a històric de baixes)
